...
public class SearchListAdapter extends ListAdapter<Recipe, SearchListAdapter.RecipeViewHolder> {

    private final static String TAG = "SearchListAdapter";

    IAdapterItemClickListener mItemClickListener;

    public SearchListAdapter(@NonNull DiffUtil.ItemCallback<Recipe> diffCallback, IAdapterItemClickListener itemClickListener) {
        super(diffCallback);
    ...
    static class RecipeViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecipeViewHolder(ItemRecyclerviewGridFilterBinding itemBinding) {
