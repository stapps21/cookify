...
import de.hdmstuttgart.recipeapp.databinding.ItemRecyclerviewHomeBinding;
...
public class HomeListAdapter extends ListAdapter<Recipe, HomeListAdapter.HomeViewHolder> {

    IAdapterItemClickListener mItemClickListener;


    public HomeListAdapter(@NonNull DiffUtil.ItemCallback<Recipe> diffCallback, IAdapterItemClickListener mItemClickListener) {
        super(diffCallback);
    ...
    public HomeListAdapter.HomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemRecyclerviewHomeBinding itemBinding = ItemRecyclerviewHomeBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
        return new HomeListAdapter.HomeViewHolder(itemBinding);
    }
    ...
    public static class HomeViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView tvRecipeName, tvSubcontent;
        private final ImageView ivFavorite;

        public HomeViewHolder(ItemRecyclerviewHomeBinding itemBinding) {
